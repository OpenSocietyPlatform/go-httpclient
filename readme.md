...
```bash
# Go Modules
require github.com/OpenSocietyPlatform/go-httpclient
```
...
```go
import "github.com/OpenSocietyPlatform/go-httpclient/gohttp"
```
...
```go
import "github.com/OpenSocietyPlatform/go-httpclient/gohttp_mock"
```
